...
Provides functions for password hashing, verification, and JWT token creation.
"""
...
# Use argon2 only - no bcrypt due to compatibility issues in the deployment environment
